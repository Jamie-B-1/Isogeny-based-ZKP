...
def get_random_point(elli_curve, l, e):
    ...
    while True:
        ...
        R = pari.ellmul(elli_curve, point, k)
        order = pari.ellorder(elli_curve, R)
        if order == pari.elltors(elli_curve)[1][0]:
            print("order of R: ", order)
            return R
...
def generate_base_points(gen_fp2, elli_curve, l_a, e_a, l_b, e_b):
    ...
    # P_a = [111 + 311 * i, 247 + 162 * t]  # SIDH parameters for l=2,3 e=4,3
    # Q_a = [290 + 176 * i, 29 + 421 * t]
    # P_b = [360 + 112 * i, 287 + 146 * t]
    # Q_b = [347 + 404 * i, 68 + 176 * t]
