...
def generate_base_points(elli_curve, gen_fp2):
    i = gen_fp2
    # points = pari.ellgenerators(elli_curve)
    P_a = [111 + 311 * i, 247 + 162 * i]  # points are initialized with x as i (so here [111 + 311*i, 247 + 162*i])
    Q_a = [290 + 176 * i, 29 + 421 * i]
    P_b = [360 + 112 * i, 287 + 146 * i]
    Q_b = [347 + 404 * i, 68 + 176 * i]
    """
    P_a = [
        ...
        2003351496878340769927496857888485805825600511617562327658105361759369326590776207465430298367135830995863247764468049749472449827 * i,
        ...
        8337004641788845819131721857290673922295053839933467431582336072726065745705096801632409264717689480409378684646781531582640287399 * i]
    Q_a = [
        ...
        7804220673805821185818875507282627517813183801913071739476129171353898518782055651068417838573748671068461643818212154265625205666 * i,
        ...
        19507679526450799728438014183641858310821309240412911974764102921372927929916615211429302545241275283904311830918752312996285161807 * i]
    P_b = [
        ...
        16306656024954733221075162754955969260730457357369697629788710022165816786748701612472655217816963254297818152946097129242450733644 * i,
        ...
        3614789590927682028814871604873208458500877330458658745597461397001311907390924812620749562716470922547140320752451448882603082824 * i]
    Q_b = [
        ...
        8224904841129032115973432646497290185163264395865958574314664346285559445962868006749870180240521074454182724558887407546736075058 * i,
        ...
        5917717394456628336842002186881500641795694051979049336189885252227184440851721545191446902294118704165036223586306979148424339996 * i]
    """
...
def create_curve(l_a, e_a, l_b, e_b, cofactor):
    ...
    P_a, Q_a, P_b, Q_b = generate_base_points(elli_curve, gen_fp2)
